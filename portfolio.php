...
<body>
	...
	<div class="container">
		<div class="row">
			<?php if($pro1enabled == true) { ?>
	        <div class="col s6 m6">
	        	<div class="card">
	            	<div class="card-content black-text">
	              		<span class="card-title"><?php echo $pro1; ?></span>
	              		<p><?php echo $pro1desc; ?></p>
	            	</div>
	            	<div class="card-action">
	              		<a href="<?php echo $pro1Link; ?>" class="blue-text"><?php echo $pro1LinkName; ?></a>
	              		<a href="<?php echo $pro1Link2; ?>" class="blue-text right"><?php echo $pro1Link2Name; ?></a>
	            	</div>
	          	</div>
			</div>
			<?php } ?>

			<?php if($pro2enabled == true) { ?>
	        <div class="col s6 m6">
	        	<div class="card">
	            	<div class="card-content black-text">
	              		<span class="card-title"><?php echo $pro2; ?></span>
	              		<p><?php echo $pro2desc; ?></p>
	            	</div>
	            	<div class="card-action">
	              		<a href="<?php echo $pro2Link; ?>" class="blue-text"><?php echo $pro2LinkName; ?></a>
	              		<a href="<?php echo $pro2Link2; ?>" class="blue-text right"><?php echo $pro2Link2Name; ?></a>
	            	</div>
	          	</div>
			</div>
			<?php } ?>
	    ...
	    <div class="row">
	        <?php if($pro3enabled == true) { ?>
	        <div class="col s6 m6">
	        	<div class="card">
	            	<div class="card-content black-text">
	              		<span class="card-title"><?php echo $pro3; ?></span>
	              		<p><?php echo $pro3desc; ?></p>
	            	</div>
	            	<div class="card-action">
	              		<a href="<?php echo $pro3Link; ?>" class="blue-text"><?php echo $pro3LinkName; ?></a>
	              		<a href="<?php echo $pro3Link2; ?>" class="blue-text right"><?php echo $pro3Link2Name; ?></a>
	            	</div>
	          	</div>
			</div>
			<?php } ?>

			<?php if($pro4enabled == true) { ?>
	        <div class="col s6 m6">
	        	<div class="card">
	            	<div class="card-content black-text">
	              		<span class="card-title"><?php echo $pro4; ?></span>
	              		<p><?php echo $pro4desc; ?></p>
	            	</div>
	            	<div class="card-action">
	              		<a href="<?php echo $pro4Link; ?>" class="blue-text"><?php echo $pro4LinkName; ?></a>
	              		<a href="<?php echo $pro4Link2; ?>" class="blue-text right"><?php echo $pro4Link2Name; ?></a>
	            	</div>
	          	</div>
			</div>
			<?php } ?>
